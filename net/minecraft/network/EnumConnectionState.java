...
import net.minecraft.SonOyuncu.packets.C80Info;
import net.minecraft.SonOyuncu.packets.S80ServerData;
import net.minecraft.SonOyuncu.packets.S82DiscordRPC;
...
public enum EnumConnectionState {
    ...
    PLAY(0) {
        {
            ...
            this.registerPacket(EnumPacketDirection.CLIENTBOUND, 80, S80ServerData.class);
            this.registerPacket(EnumPacketDirection.CLIENTBOUND, 82, S82DiscordRPC.class);
            this.registerPacket(EnumPacketDirection.SERVERBOUND, 80, C80Info.class);
        }
    },
    STATUS(1) {
        {
    ...
    protected EnumConnectionState registerPacket(EnumPacketDirection direction, int id, Class<? extends Packet> packetClass) {
